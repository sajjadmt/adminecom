                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">
                                ...
                                @endforeach
                                    <form method="POST" action="{{ route('panel.update.specification') }}">
                                    @csrf
                                        ...
                                        <div class="row mb-3">
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <input name="title" value="{{ $specification->title }}" class="form-control me-2" type="text"
                                                           required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <select required name="status" id="status-select"
                                                    ...
                                                    <option
                                                        value="active" {{ $specification->status == "active" ? 'selected' : '' }}>
                                                        Active
                                                    </option>
                                                    <option
                                                        value="inactive" {{ $specification->status == "inactive" ? 'selected' : '' }}>
                                                        Inactive
                                                    </option>
                                                </select>
                                            </div>
